-- Template: time_daypart_time_date_category_store_location
-- Business Question: "When do customers shop for specific Day Part, Date, Product Category, Store Location?"
-- Dimensional Analysis: Day Part × Date × Product Category × Store Location
...
ORDER BY total_revenue DESC, time_daypart, time_date, category, store_location
LIMIT ${limit:=100};
