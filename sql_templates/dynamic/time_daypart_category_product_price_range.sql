-- Template: time_daypart_category_product_price_range
-- Business Question: "When do customers shop for specific Day Part, Product Category, Product, Price Range?"
-- Dimensional Analysis: Day Part × Product Category × Product × Price Range
...
ORDER BY total_revenue DESC, time_daypart, category, product, price_range
LIMIT ${limit:=100};
