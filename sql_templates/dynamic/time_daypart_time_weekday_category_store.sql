-- Template: time_daypart_time_weekday_category_store
-- Business Question: "When do customers shop for specific Day Part, Day of Week, Product Category, Store?"
-- Dimensional Analysis: Day Part × Day of Week × Product Category × Store
...
ORDER BY total_revenue DESC, time_daypart, time_weekday, category, store
LIMIT ${limit:=100};
