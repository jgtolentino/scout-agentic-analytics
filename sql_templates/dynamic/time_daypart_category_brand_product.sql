-- Template: time_daypart_category_brand_product
-- Business Question: "When do customers shop for specific Day Part, Product Category, Brand, Product?"
-- Dimensional Analysis: Day Part × Product Category × Brand × Product
...
ORDER BY total_revenue DESC, time_daypart, category, brand, product
LIMIT ${limit:=100};
