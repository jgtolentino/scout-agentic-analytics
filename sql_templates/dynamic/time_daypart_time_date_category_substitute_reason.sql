-- Template: time_daypart_time_date_category_substitute_reason
-- Business Question: "When do customers shop for specific Day Part, Date, Product Category, Substitution Reason?"
-- Dimensional Analysis: Day Part × Date × Product Category × Substitution Reason
...
ORDER BY total_revenue DESC, time_daypart, time_date, category, substitute_reason
LIMIT ${limit:=100};
