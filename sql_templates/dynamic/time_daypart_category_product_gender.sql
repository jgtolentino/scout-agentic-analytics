-- Template: time_daypart_category_product_gender
-- Business Question: "When do customers shop for specific Day Part, Product Category, Product, Customer Gender?"
-- Dimensional Analysis: Day Part × Product Category × Product × Customer Gender
...
ORDER BY total_revenue DESC, time_daypart, category, product, gender
LIMIT ${limit:=100};
