-- Template: time_daypart_category_age_bracket_substitute_reason
-- Business Question: "When do customers shop for specific Day Part, Product Category, Age Bracket, Substitution Reason?"
-- Dimensional Analysis: Day Part × Product Category × Age Bracket × Substitution Reason
...
-- ${{agebracket}} - Optional age bracket filter
...
ORDER BY total_revenue DESC, time_daypart, category, age_bracket, substitute_reason
LIMIT ${limit:=100};
...
-- 6. Demographic data may have null values - results show available data only