-- Template: time_daypart_category_brand_substitute_reason
-- Business Question: "When do customers shop for specific Day Part, Product Category, Brand, Substitution Reason?"
-- Dimensional Analysis: Day Part × Product Category × Brand × Substitution Reason
...
ORDER BY total_revenue DESC, time_daypart, category, brand, substitute_reason
LIMIT ${limit:=100};
