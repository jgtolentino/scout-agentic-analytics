-- Template: time_daypart_time_weekday_category_substitute_reason
-- Business Question: "When do customers shop for specific Day Part, Day of Week, Product Category, Substitution Reason?"
-- Dimensional Analysis: Day Part × Day of Week × Product Category × Substitution Reason
...
WITH dimensional_base AS (
    ...
    DATENAME(weekday, transactiondate) AS time_weekday,
...
ORDER BY total_revenue DESC, time_daypart, time_weekday, category, substitute_reason
LIMIT ${limit:=100};
