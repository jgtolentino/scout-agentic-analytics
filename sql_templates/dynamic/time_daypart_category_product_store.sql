-- Template: time_daypart_category_product_store
-- Business Question: "When do customers shop for specific Day Part, Product Category, Product, Store?"
-- Dimensional Analysis: Day Part × Product Category × Product × Store
...
ORDER BY total_revenue DESC, time_daypart, category, product, store
LIMIT ${limit:=100};
