-- Template: time_daypart_category_gender_substitute_reason
-- Business Question: "When do customers shop for specific Day Part, Product Category, Customer Gender, Substitution Reason?"
-- Dimensional Analysis: Day Part × Product Category × Customer Gender × Substitution Reason
...
ORDER BY total_revenue DESC, time_daypart, category, gender, substitute_reason
LIMIT ${limit:=100};
