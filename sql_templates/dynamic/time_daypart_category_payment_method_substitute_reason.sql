-- Template: time_daypart_category_payment_method_substitute_reason
-- Business Question: "When do customers shop for specific Day Part, Product Category, Payment Method, Substitution Reason?"
-- Dimensional Analysis: Day Part × Product Category × Payment Method × Substitution Reason
...
ORDER BY total_revenue DESC, time_daypart, category, payment_method, substitute_reason
LIMIT ${limit:=100};
