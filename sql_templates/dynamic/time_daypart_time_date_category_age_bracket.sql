-- Template: time_daypart_time_date_category_age_bracket
-- Business Question: "When do customers shop for specific Day Part, Date, Product Category, Age Bracket?"
-- Dimensional Analysis: Day Part × Date × Product Category × Age Bracket
...
ORDER BY total_revenue DESC, time_daypart, time_date, category, age_bracket
LIMIT ${limit:=100};
