-- Template: brand_store_gender_age_bracket
-- Business Question: "How do stores compare across Brand, Store, Customer Gender, Age Bracket?"
-- Dimensional Analysis: Brand × Store × Customer Gender × Age Bracket
...
ORDER BY total_revenue DESC, brand, store, gender, age_bracket
LIMIT ${limit:=100};
