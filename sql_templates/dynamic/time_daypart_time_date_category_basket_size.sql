-- Template: time_daypart_time_date_category_basket_size
-- Business Question: "When do customers shop for specific Day Part, Date, Product Category, Basket Size?"
-- Dimensional Analysis: Day Part × Date × Product Category × Basket Size
...
ORDER BY total_revenue DESC, time_daypart, time_date, category, basket_size
LIMIT ${limit:=100};
