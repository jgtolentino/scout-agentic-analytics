-- Template: time_daypart_time_date_category_product
-- Business Question: "When do customers shop for specific Day Part, Date, Product Category, Product?"
-- Dimensional Analysis: Day Part × Date × Product Category × Product
...
ORDER BY total_revenue DESC, time_daypart, time_date, category, product
LIMIT ${limit:=100};
