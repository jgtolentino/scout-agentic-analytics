-- Template: time_daypart_time_date_category_store
-- Business Question: "When do customers shop for specific Day Part, Date, Product Category, Store?"
-- Dimensional Analysis: Day Part × Date × Product Category × Store
...
ORDER BY total_revenue DESC, time_daypart, time_date, category, store
LIMIT ${limit:=100};
