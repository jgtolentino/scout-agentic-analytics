-- Template: time_daypart_category_product_basket_size
-- Business Question: "When do customers shop for specific Day Part, Product Category, Product, Basket Size?"
-- Dimensional Analysis: Day Part × Product Category × Product × Basket Size
...
ORDER BY total_revenue DESC, time_daypart, category, product, basket_size
LIMIT ${limit:=100};
