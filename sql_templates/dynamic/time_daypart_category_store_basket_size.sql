-- Template: time_daypart_category_store_basket_size
-- Business Question: "When do customers shop for specific Day Part, Product Category, Store, Basket Size?"
-- Dimensional Analysis: Day Part × Product Category × Store × Basket Size
...
ORDER BY total_revenue DESC, time_daypart, category, store, basket_size
LIMIT ${limit:=100};
