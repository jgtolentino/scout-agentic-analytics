-- Template: time_daypart_category_store_age_bracket
-- Business Question: "When do customers shop for specific Day Part, Product Category, Store, Age Bracket?"
-- Dimensional Analysis: Day Part × Product Category × Store × Age Bracket
...
ORDER BY total_revenue DESC, time_daypart, category, store, age_bracket
LIMIT ${limit:=100};
