-- Template: time_daypart_time_date_category_brand
-- Business Question: "When do customers shop for specific Day Part, Date, Product Category, Brand?"
-- Dimensional Analysis: Day Part × Date × Product Category × Brand
...
ORDER BY total_revenue DESC, time_daypart, time_date, category, brand
LIMIT ${limit:=100};
