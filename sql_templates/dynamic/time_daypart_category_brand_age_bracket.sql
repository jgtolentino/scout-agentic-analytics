-- Template: time_daypart_category_brand_age_bracket
-- Business Question: "When do customers shop for specific Day Part, Product Category, Brand, Age Bracket?"
-- Dimensional Analysis: Day Part × Product Category × Brand × Age Bracket
...
ORDER BY total_revenue DESC, time_daypart, category, brand, age_bracket
LIMIT ${limit:=100};
