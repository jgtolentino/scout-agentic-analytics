-- Template: time_daypart_category_store_price_range
-- Business Question: "When do customers shop for specific Day Part, Product Category, Store, Price Range?"
-- Dimensional Analysis: Day Part × Product Category × Store × Price Range
...
ORDER BY total_revenue DESC, time_daypart, category, store, price_range
LIMIT ${limit:=100};
