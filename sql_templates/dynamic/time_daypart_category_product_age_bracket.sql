-- Template: time_daypart_category_product_age_bracket
-- Business Question: "When do customers shop for specific Day Part, Product Category, Product, Age Bracket?"
-- Dimensional Analysis: Day Part × Product Category × Product × Age Bracket
...
ORDER BY total_revenue DESC, time_daypart, category, product, age_bracket
LIMIT ${limit:=100};
