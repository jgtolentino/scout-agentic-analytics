-- Template: time_daypart_category_brand_payment_method
-- Business Question: "When do customers shop for specific Day Part, Product Category, Brand, Payment Method?"
-- Dimensional Analysis: Day Part × Product Category × Brand × Payment Method
...
ORDER BY total_revenue DESC, time_daypart, category, brand, payment_method
LIMIT ${limit:=100};
