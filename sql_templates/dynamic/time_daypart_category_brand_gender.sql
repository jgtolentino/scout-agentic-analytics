-- Template: time_daypart_category_brand_gender
-- Business Question: "When do customers shop for specific Day Part, Product Category, Brand, Customer Gender?"
-- Dimensional Analysis: Day Part × Product Category × Brand × Customer Gender
...
ORDER BY total_revenue DESC, time_daypart, category, brand, gender
LIMIT ${limit:=100};
