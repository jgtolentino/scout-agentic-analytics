-- Template: time_daypart_time_date_category_payment_method
-- Business Question: "When do customers shop for specific Day Part, Date, Product Category, Payment Method?"
-- Dimensional Analysis: Day Part × Date × Product Category × Payment Method
...
ORDER BY total_revenue DESC, time_daypart, time_date, category, payment_method
LIMIT ${limit:=100};
