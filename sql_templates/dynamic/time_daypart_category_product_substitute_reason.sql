-- Template: time_daypart_category_product_substitute_reason
-- Business Question: "When do customers shop for specific Day Part, Product Category, Product, Substitution Reason?"
-- Dimensional Analysis: Day Part × Product Category × Product × Substitution Reason
...
ORDER BY total_revenue DESC, time_daypart, category, product, substitute_reason
LIMIT ${limit:=100};
