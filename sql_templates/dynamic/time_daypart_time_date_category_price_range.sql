-- Template: time_daypart_time_date_category_price_range
-- Business Question: "When do customers shop for specific Day Part, Date, Product Category, Price Range?"
-- Dimensional Analysis: Day Part × Date × Product Category × Price Range
...
WITH dimensional_base AS (
    ...
    CAST(transactiondate AS date) AS time_date,
...
ORDER BY total_revenue DESC, time_daypart, time_date, category, price_range
LIMIT ${limit:=100};
