-- Template: time_daypart_category_product_payment_method
-- Business Question: "When do customers shop for specific Day Part, Product Category, Product, Payment Method?"
-- Dimensional Analysis: Day Part × Product Category × Product × Payment Method
...
ORDER BY total_revenue DESC, time_daypart, category, product, payment_method
LIMIT ${limit:=100};
