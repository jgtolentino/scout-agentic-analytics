-- Template: time_daypart_category_store_gender
-- Business Question: "When do customers shop for specific Day Part, Product Category, Store, Customer Gender?"
-- Dimensional Analysis: Day Part × Product Category × Store × Customer Gender
...
ORDER BY total_revenue DESC, time_daypart, category, store, gender
LIMIT ${limit:=100};
