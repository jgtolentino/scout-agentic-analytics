-- Template: time_daypart_category_store
-- Business Question: "When do customers shop for specific Day Part, Product Category, Store?"
-- Dimensional Analysis: Day Part × Product Category × Store
-- Combination Type: 3-way cross-tabulation
...
ORDER BY total_revenue DESC, time_daypart, category, store
LIMIT ${limit:=100};
