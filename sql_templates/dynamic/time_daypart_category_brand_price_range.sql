-- Template: time_daypart_category_brand_price_range
-- Business Question: "When do customers shop for specific Day Part, Product Category, Brand, Price Range?"
-- Dimensional Analysis: Day Part × Product Category × Brand × Price Range
...
ORDER BY total_revenue DESC, time_daypart, category, brand, price_range
LIMIT ${limit:=100};
