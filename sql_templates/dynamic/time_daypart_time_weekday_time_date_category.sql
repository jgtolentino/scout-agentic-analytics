-- Template: time_daypart_time_weekday_time_date_category
-- Business Question: "When do customers shop for specific Day Part, Day of Week, Date, Product Category?"
-- Dimensional Analysis: Day Part × Day of Week × Date × Product Category
...
ORDER BY total_revenue DESC, time_daypart, time_weekday, time_date, category
LIMIT ${limit:=100};
