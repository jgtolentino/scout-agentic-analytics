-- Template: time_daypart_category_store_payment_method
-- Business Question: "When do customers shop for specific Day Part, Product Category, Store, Payment Method?"
-- Dimensional Analysis: Day Part × Product Category × Store × Payment Method
...
ORDER BY total_revenue DESC, time_daypart, category, store, payment_method
LIMIT ${limit:=100};
