-- Template: time_daypart_category_brand_store
-- Business Question: "When do customers shop for specific Day Part, Product Category, Brand, Store?"
-- Dimensional Analysis: Day Part × Product Category × Brand × Store
...
ORDER BY total_revenue DESC, time_daypart, category, brand, store
LIMIT ${limit:=100};
