-- Template: time_daypart_category_brand_basket_size
-- Business Question: "When do customers shop for specific Day Part, Product Category, Brand, Basket Size?"
-- Dimensional Analysis: Day Part × Product Category × Brand × Basket Size
...
ORDER BY total_revenue DESC, time_daypart, category, brand, basket_size
LIMIT ${limit:=100};
