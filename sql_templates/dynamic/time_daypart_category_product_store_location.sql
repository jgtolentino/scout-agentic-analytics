-- Template: time_daypart_category_product_store_location
-- Business Question: "When do customers shop for specific Day Part, Product Category, Product, Store Location?"
-- Dimensional Analysis: Day Part × Product Category × Product × Store Location
...
ORDER BY total_revenue DESC, time_daypart, category, product, store_location
LIMIT ${limit:=100};
