-- Template: time_daypart_category_store_substitute_reason
-- Business Question: "When do customers shop for specific Day Part, Product Category, Store, Substitution Reason?"
-- Dimensional Analysis: Day Part × Product Category × Store × Substitution Reason
...
ORDER BY total_revenue DESC, time_daypart, category, store, substitute_reason
LIMIT ${limit:=100};
