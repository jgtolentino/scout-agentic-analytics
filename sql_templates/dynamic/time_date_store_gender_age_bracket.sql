-- Template: time_date_store_gender_age_bracket
-- Business Question: "How do shopping times vary across Date, Store, Customer Gender, Age Bracket?"
-- Dimensional Analysis: Date × Store × Customer Gender × Age Bracket
...
ORDER BY total_revenue DESC, time_date, store, gender, age_bracket
LIMIT ${limit:=100};
