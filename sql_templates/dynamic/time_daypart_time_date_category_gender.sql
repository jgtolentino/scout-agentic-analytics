-- Template: time_daypart_time_date_category_gender
-- Business Question: "When do customers shop for specific Day Part, Date, Product Category, Customer Gender?"
-- Dimensional Analysis: Day Part × Date × Product Category × Customer Gender
...
ORDER BY total_revenue DESC, time_daypart, time_date, category, gender
LIMIT ${limit:=100};
