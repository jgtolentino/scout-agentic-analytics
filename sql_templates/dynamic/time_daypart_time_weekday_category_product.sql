-- Template: time_daypart_time_weekday_category_product
-- Business Question: "When do customers shop for specific Day Part, Day of Week, Product Category, Product?"
-- Dimensional Analysis: Day Part × Day of Week × Product Category × Product
...
ORDER BY total_revenue DESC, time_daypart, time_weekday, category, product
LIMIT ${limit:=100};
