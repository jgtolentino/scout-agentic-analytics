-- Template: time_daypart_category_brand_store_location
-- Business Question: "When do customers shop for specific Day Part, Product Category, Brand, Store Location?"
-- Dimensional Analysis: Day Part × Product Category × Brand × Store Location
...
ORDER BY total_revenue DESC, time_daypart, category, brand, store_location
LIMIT ${limit:=100};
