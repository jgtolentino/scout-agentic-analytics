-- Template: product_store_gender_age_bracket
-- Business Question: "How do stores compare across Product, Store, Customer Gender, Age Bracket?"
-- Dimensional Analysis: Product × Store × Customer Gender × Age Bracket
...
ORDER BY total_revenue DESC, product, store, gender, age_bracket
LIMIT ${limit:=100};
