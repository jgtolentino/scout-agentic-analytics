-- Template: time_daypart_time_weekday_category_brand
-- Business Question: "When do customers shop for specific Day Part, Day of Week, Product Category, Brand?"
-- Dimensional Analysis: Day Part × Day of Week × Product Category × Brand
...
ORDER BY total_revenue DESC, time_daypart, time_weekday, category, brand
LIMIT ${limit:=100};
