-- ========================================================================
-- Scout Analytics Platform - Production-Safe Flat Export View (SIMPLE)
-- Migration: 2025-09-25_v_flat_export_sheet_SIMPLE.sql
-- Purpose: Create flattened, merged, enriched dataframe view - simplified version
-- ========================================================================
...
SELECT
  ...
  -- Other_Products: Simplified - empty for now since schema mapping is complex
  '' AS Other_Products,
