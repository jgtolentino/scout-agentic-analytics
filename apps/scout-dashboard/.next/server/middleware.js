...
var _edge_runtime_cookies = __webpack_require__(720);
...
var native_url = __webpack_require__(334);
...
function clearPreviewData(res, options = {}) {
    ...
    const { serialize } = __webpack_require__(440);
...
async function middleware(req) {
    ...
    if (pathname.startsWith("/_next") || pathname.startsWith("/favicon.ico") || pathname.startsWith("/api/health")) {
        return res;
    }
...
(function() {
    var e = {
        452: function(e) {
            "use strict";
            e.exports = __webpack_require__(672);
        }
    };
    var t = {};
