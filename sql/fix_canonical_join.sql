-- Fix the JOIN using correct canonical transaction ID mapping
...
SELECT
  ...
  -- Authoritative time from SalesInteractions using correct JOIN
...
JOIN dbo.SalesInteractions si
  ON pt.sessionId = si.InteractionID  -- << CORRECT JOIN: sessionId = InteractionID
